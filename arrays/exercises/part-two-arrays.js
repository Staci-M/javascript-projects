...
removedElement = cargoHold.pop();
console.log('The removed element is: ' + removedElement  + ', and the updated array is: ' + cargoHold);

//3) Remove the first item from the array with shift. Print the element removed and the updated array.
removedWithShift = cargoHold.shift();
...
console.log(`The filal array is ${cargoHold} and it's length is ${cargoHold.length}.`);
